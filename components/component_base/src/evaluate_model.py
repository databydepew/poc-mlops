...
def evaluate_model(
    ...
    """Custom component that evaluates a saved model from GCS and prints the evaluation metrics.

    Args:
        model_directory: GS location of saved model.
        data_path: GS location of test data.
    ...
    try:
        resp = endpoint.predict(instances=df_test)
        pp.pprint(resp)
